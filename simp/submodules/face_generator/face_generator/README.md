...
This repository is originating from https://github.com/kaylode/image-inpainting repo.
Changes in this repo comparing to original:
- Added annotation generator & image resizer
- Added our own datasets
- Trained & added our own weights for both segmentation and GAN networks
- Rewrote the code to improve it.
